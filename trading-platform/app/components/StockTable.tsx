...
export const StockTable = memo(({ 
  ...
  // Use ref to track stocks for adaptive polling without triggering re-renders
  ...
  // Uses ref to avoid dependency on stocks array
  ...
  useEffect(() => {
    ...
    const fetchQuotes = async () => {
      ...
      await measureAsync('fetchQuotes', async () => {
        // Use symbolKey split or stocksRef, symbolKey is better as it triggers this effect
