...
export const PerformanceDashboard: React.FC = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      // Note: getMetrics returns Record<string, PerformanceMetric>, not arrays
      // This component needs refactoring to match the actual API
      const currentMetrics = performanceMonitor.getMetrics() as unknown as {
        renderTimes: number[];
        apiCallDurations: number[];
        websocketMessageRates: number[];
        cacheHitRates: number[];
