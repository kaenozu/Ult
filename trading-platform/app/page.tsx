...
export default function Workstation() {
  ...
  useEffect(() => {
    ...
    if (storeSelectedStock) {
      // Optimize: Only fetch if the symbol changed to prevent redundant fetches on watchlist updates
    ...
    // Priority 2: If no global selection but watchlist has items, show the first one
      ...
      // Optimize: Only fetch if the symbol changed to prevent redundant fetches
