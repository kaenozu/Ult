...
export const JAPAN_STOCKS: Stock[] = [
  ...
  { symbol: '6501', name: 'キヤノン', market: 'japan', sector: '電機', price: 4500, change: 0, changePercent: 0, volume: 0 },
  ...
  { symbol: '6702', name: '信越化学', market: 'japan', sector: '化学', price: 6200, change: 0, changePercent: 0, volume: 0 },
];
