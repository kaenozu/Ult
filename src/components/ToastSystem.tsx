...
export const useErrorToast = () => {
  ...
  return useCallback(
    (
      ...
      const toast: Omit<Toast, 'id'> = { type: 'error', title, ...options };
...
export const useWarningToast = () => {
  ...
  return useCallback(
    (
      ...
      const toast: Omit<Toast, 'id'> = { type: 'warning', title, ...options };
      if (description !== undefined) {
        toast.description = description;
      }
      addToast(toast);
...
export const useInfoToast = () => {
  ...
  return useCallback(
    (
      ...
      const toast: Omit<Toast, 'id'> = { type: 'info', title, ...options };
      if (description !== undefined) {
        toast.description = description;
      }
      addToast(toast);
