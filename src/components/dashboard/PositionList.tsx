...
import { Coins, AlertTriangle, TrendingUp, TrendingDown, ArrowRight } from 'lucide-react';
        ...
        <div className="flex items-center justify-between p-4 bg-muted/20 rounded-lg mb-3">
            <div>
                <div className="flex items-center gap-2">
                    <Link href={`/stocks/${ticker}`} className="font-bold text-lg hover:underline decoration-primary">
                        {ticker}
                    </Link>
                    {showAlert && (
            ...
            <div className="text-right">
                ...
                <div className={`text-sm font-bold flex items-center justify-end ${isProfit ? 'text-green-500' : 'text-red-500'}`}>
            ...
            <div className="ml-4">
                <TradingModal
                    ...
                    trigger={
                        <Button size="sm" variant={showAlert ? "default" : "outline"} className={showAlert ? "bg-rose-500 hover:bg-rose-600 border-none text-white shadow-md" : ""}>
                            売却
                        </Button>
                    }
                />
