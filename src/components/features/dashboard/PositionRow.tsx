...
import { usePnL } from '@/components/shared/hooks/business/usePnL';
import { useAlert } from '@/components/shared/hooks/ui/useAlert';
...
const PositionRow = React.memo<PositionRowProps>(function PositionRow({
  position,
}) {
