...
> ⚠️ **注意**: Codex使用制限により、自動AIレビューが一時的に利用できません。手動レビューを優先してください。詳細は[Codex利用制限ガイド](./CODEX_USAGE_LIMITS_GUIDE.md)を参照してください。
...
このリポジトリは `chatgpt-codex-connector` による自動コードレビューを利用しています。
...
**制限事項**: 自動レビューシステムはクレジット制です。クレジットが不足している場合、手動レビューにフォールバックします。

**詳細**: [.github/CODE_REVIEW_SETUP.md](.github/CODE_REVIEW_SETUP.md) を参照してください。
